...
const allProducts: Record<string, Product[]> = {
  ...
  `,
    ...
    `,
      ...
      image: '/Apparel/Denim Jackets/Classic Denim Jackets/Classic Denim Jackets 3.png',
      images: [
        '/Apparel/Denim Jackets/Classic Denim Jackets/Classic Denim Jackets 1.png',
        '/Apparel/Denim Jackets/Classic Denim Jackets/Classic Denim Jackets 2.png',
        '/Apparel/Denim Jackets/Classic Denim Jackets/Classic Denim Jackets 3.png'
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Jackets/Denim Bomber Jackets/Denim Bomber Jackets 2.png',
      images: [
        '/Apparel/Denim Jackets/Denim Bomber Jackets/Denim Bomber Jackets 1.png',
        '/Apparel/Denim Jackets/Denim Bomber Jackets/Denim Bomber Jackets 2.png',
        '/Apparel/Denim Jackets/Denim Bomber Jackets/Denim Bomber Jackets 3.png',
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Jackets/Oversized Denim Jackets/Oversized Denim Jackets 2.png',
      images: [
        '/Apparel/Denim Jackets/Oversized Denim Jackets/Oversized Denim Jackets 1.png',
        '/Apparel/Denim Jackets/Oversized Denim Jackets/Oversized Denim Jackets 2.png',
        '/Apparel/Denim Jackets/Oversized Denim Jackets/Oversized Denim Jackets 3.png',
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Jackets/Trucker Jackets/Trucker Jackets 3.png',
      images: [
        '/Apparel/Denim Jackets/Trucker Jackets/Trucker Jackets 1.png',
        '/Apparel/Denim Jackets/Trucker Jackets/Trucker Jackets 2.png',
        '/Apparel/Denim Jackets/Trucker Jackets/Trucker Jackets 3.png',
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Shirts/Button Down Shirts/Button Down Shirts 1.png',
      images: [
        '/Apparel/Denim Shirts/Button Down Shirts/Button Down Shirts 1.png',
        '/Apparel/Denim Shirts/Button Down Shirts/Button Down Shirts 2.png',
        '/Apparel/Denim Shirts/Button Down Shirts/Button Down Shirts 3.png'
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Shirts/Chambray Shirts/Chambray Shirts 1.png',
      images: [
        '/Apparel/Denim Shirts/Chambray Shirts/Chambray Shirts 1.png',
        '/Apparel/Denim Shirts/Chambray Shirts/Chambray Shirts 2.png',
        '/Apparel/Denim Shirts/Chambray Shirts/Chambray Shirts 3.png',
      ],
      category: 'apparel'
    },

    {
      ...
      image: '/Apparel/Denim Skirts/A-line Skirt/A-line Skirts 1.png',
      images: [
        '/Apparel/Denim Skirts/A-line Skirt/A-line Skirts 1.png',
        '/Apparel/Denim Skirts/A-line Skirt/A-line Skirts 2.png',
        '/Apparel/Denim Skirts/A-line Skirt/A-line Skirts 3.png'
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Skirts/Denim Maxi Skirts/Denim Maxi Skirts 1.png',
      images: [
        '/Apparel/Denim Skirts/Denim Maxi Skirts/Denim Maxi Skirts 1.png',
        '/Apparel/Denim Skirts/Denim Maxi Skirts/Denim Maxi Skirts 2.png',
        '/Apparel/Denim Skirts/Denim Maxi Skirts/Denim Maxi Skirts 3.png',
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Skirts/Denim Midi Skirts/Denim Midi Skirts 1.png',
      images: [
        '/Apparel/Denim Skirts/Denim Midi Skirts/Denim Midi Skirts 1.png',
        '/Apparel/Denim Skirts/Denim Midi Skirts/Denim Midi Skirts 2.png',
        '/Apparel/Denim Skirts/Denim Midi Skirts/Denim Midi Skirts 3.png',
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Denim Skirts/Denim Mini Skirts/Denim Mini Skirts 2.png',
      images: [
        '/Apparel/Denim Skirts/Denim Mini Skirts/Denim Mini Skirts 1.png',
        '/Apparel/Denim Skirts/Denim Mini Skirts/Denim Mini Skirts 2.png',
        '/Apparel/Denim Skirts/Denim Mini Skirts/Denim Mini Skirts 3.png',
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      ...
      image: '/Apparel/Overalls and Dungarees/Bib Overalls/Bib Overalls 3.png',
      images: [
        '/Apparel/Overalls and Dungarees/Bib Overalls/Bib Overalls 1.png',
        '/Apparel/Overalls and Dungarees/Bib Overalls/Bib Overalls 2.png',
        '/Apparel/Overalls and Dungarees/Bib Overalls/Bib Overalls 3.png'
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      image: '/Apparel/Denim Dresses/Shirt Dresses/Shirt Dresses 1.png',
      images: [
        '/Apparel/Denim Dresses/Shirt Dresses/Shirt Dresses 1.png',
        '/Apparel/Denim Dresses/Shirt Dresses/Shirt Dresses 2.png',
        '/Apparel/Denim Dresses/Shirt Dresses/Shirt Dresses 3.png'
      ],
      category: 'apparel'
    },
    {
    ...
    `,
      image: '/Apparel/Denim Dresses/Slip Dresses/Slip Dresses 1.png',
      images: [
        '/Apparel/Denim Dresses/Slip Dresses/Slip Dresses 1.png',
        '/Apparel/Denim Dresses/Slip Dresses/Slip Dresses 2.png',
        '/Apparel/Denim Dresses/Slip Dresses/Slip Dresses 3.png',
    ...
    `,
      image: '/Apparel/Denim Dresses/Sundresses/Sundresses 1.png',
      images: [
        '/Apparel/Denim Dresses/Sundresses/Sundresses 1.png',
        '/Apparel/Denim Dresses/Sundresses/Sundresses 2.png',
        '/Apparel/Denim Dresses/Sundresses/Sundresses 3.png',
      ],
      category: 'apparel'
    },
    {
...
const ProductCategory = () => {
  ...
  const filters: Record<string, string[]> = {
    'apparel': ['Jeans', 'Jackets', 'Skirts', 'Shirts', 'Dresses', 'Shorts', 'Overalls and Dungarees'],
    'accessories': ['Tote Bags', "Overnight Totes", 'Backpacks', 'Hats and Caps', "Denim Headbands", 'Denim Belts', 'Wallets and Pouches'],
    'footwear': ['Sneakers', 'Boots'],
    'home-and-lifestyle': ['Cushion Covers', 'Table Runners', 'Aprons', 'Rugs'],
    'Denim Premium Raw Cloth': ['Raw'],
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl max-w-2xl">
              Discover our premium collection of <b><i>{category}</i></b>, where quality meets timeless style.
              From fashion to lifestyle, find the perfect blend of comfort and elegance!
            </p>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-6 flex-wrap gap-2 sm:gap-4">
            <button
              ...
              className={`px-3 py-1.5 text-sm rounded-lg font-semibold transition-colors duration-300 ${selectedFilter === 'All Products'
            ...
            {filters[category]?.map((filter: string) => (
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded-lg font-semibold transition-colors duration-300 ${selectedFilter === filter
                    ? 'bg-indigo-600 text-white'
                    : 'bg-gray-200 text-gray-800 hover:bg-indigo-500 hover:text-white'
                  }`}
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {productsToShow.length > 0 ? (
              productsToShow.map((product, index) => (
                ...
                >
                  <img src={product.image} alt={product.name} className="aspect-square rounded-lg overflow-hidden" />
          ...
          <div className="mt-6 flex justify-center space-x-4">
            ...
            {Array.from({ length: totalPages }, (_, index) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg ${currentPage === index + 1 ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-800 hover:bg-indigo-500 hover:text-white'
                  }`}
              >
                {index + 1}
              </button>
