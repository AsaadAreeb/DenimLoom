...
export const services: Service[] = [
  {
    ...
    features: [
      ...
      'Experienced craftsmen specializing in denim',
      'Custom wash, dye, and finishing options',
      'Flexible production capacities for large and small orders',
      'Stringent quality control processes',
    ],
    benefits: [
      'Consistent quality across all product lines',
      'Competitive pricing for bulk and boutique orders',
    ...
    processSteps: [
      ...
      'Production planning and material sourcing',
      'Manufacturing and quality checks',
      'Finishing, packaging, and branding',
  ...
  },
  {
    ...
    features: [
      ...
      'Optional insurance coverage for shipments',
    ],
    benefits: [
      ...
      'Professional handling of all export documentation',
    ],
    processSteps: [
  ...
  },
  {
    ...
    features: [
      ...
      'Advanced testing for fabric durability',
      'Experienced quality control team',
      'Regular audits and evaluations',
      'Detailed quality reports for every batch',
    ],
    benefits: [
      ...
      'Continuous improvement for better products',
    ],
  },
  {
    id: 'packaging',
    ...
    benefits: [
      ...
      'Customizable quantities and designs',
    ],
  },
  {
    id: 'sustainability',
    ...
    benefits: [
      ...
      'Lower production costs through efficiency',
      'Enhanced brand reputation for sustainability',
      'Compliance with environmental regulations',
      'Support for environmentally conscious consumers',
    ],
  },
  {
    id: 'market-analysis',
    ...
    benefits: [
      ...
      'Risk mitigation in market entry',
